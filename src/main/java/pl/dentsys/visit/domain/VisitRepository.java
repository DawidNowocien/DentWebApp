...
public interface VisitRepository extends JpaRepository<VisitEntity,Long>{
	...
	List<VisitEntity> findVisitsByDoctorAndDates(@Param("sc") QueryParameters searchCriteria);
	...
	List<VisitEntity> findVisitsByDoctorAndPatientidAndDates(@Param("sc") QueryParameters searchCriteria);
